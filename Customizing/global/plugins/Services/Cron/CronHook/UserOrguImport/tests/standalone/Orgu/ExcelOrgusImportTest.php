...
class ExcelOrgusPathImportTest extends PHPUnit_Framework_TestCase
{
	...
	public function test_distinct_orgu_paths()
	{
		$extracted =
			...
			,[EO::COLUMN_LE => 'le1', EO::COLUMN_RESSORT => 'r1', EO::COLUMN_DEPARTMENT => 'd1', EO::COLUMN_GROUP => 'g1', EO::COLUMN_TEAM => EO::NO_ASSIGNMENT]
			,[EO::COLUMN_LE => 'le1', EO::COLUMN_RESSORT => 'r1', EO::COLUMN_DEPARTMENT => 'd2', EO::COLUMN_GROUP => 'g1', EO::COLUMN_TEAM => 't1']
			,[EO::COLUMN_LE => 'le1', EO::COLUMN_RESSORT => 'r2', EO::COLUMN_DEPARTMENT => 'd3', EO::COLUMN_GROUP => 'd3', EO::COLUMN_TEAM => EO::NO_ASSIGNMENT]
			,[EO::COLUMN_LE => 'le1', EO::COLUMN_RESSORT => 'r1', EO::COLUMN_DEPARTMENT => 'd1', EO::COLUMN_GROUP => 'g1', EO::COLUMN_TEAM => EO::NO_ASSIGNMENT]
			,[EO::COLUMN_LE => 'le1', EO::COLUMN_RESSORT => 'r1', EO::COLUMN_DEPARTMENT => 'd2', EO::COLUMN_GROUP => 'g1', EO::COLUMN_TEAM => 't1']
			,[EO::COLUMN_LE => 'le1', EO::COLUMN_RESSORT => 'r2', EO::COLUMN_DEPARTMENT => 'd3', EO::COLUMN_GROUP => 'd3', EO::COLUMN_TEAM => EO::NO_ASSIGNMENT]
			,[EO::COLUMN_LE => 'le1', EO::COLUMN_RESSORT => 'r1', EO::COLUMN_DEPARTMENT => 'd1', EO::COLUMN_GROUP => 'g1', EO::COLUMN_TEAM => EO::NO_ASSIGNMENT]
			...
			,[EO::COLUMN_LE => 'le3', EO::COLUMN_RESSORT => EO::NO_ASSIGNMENT, EO::COLUMN_DEPARTMENT => EO::NO_ASSIGNMENT, EO::COLUMN_GROUP => EO::NO_ASSIGNMENT, EO::COLUMN_TEAM => EO::NO_ASSIGNMENT]
		];
