...
class ilObjBuildingBlockPoolGUI extends ilObjectPluginGUI {
	...
	*/
	public function performCommand() {
		...
		switch ($cmd) {
			...
			case "addBuildingBlock":
				...
				$this->gTpl->setContent($bb_edit->getHtml());
				break;
			case "addBlankBuildingBlock":
				$bb_edit = $this->getBuildingBlockEditGUI(gevSettings::EDIT_BUILDING_BLOCKS, $_GET["bb_id"], ilBuildingBlockEditGUI::NEW_BLANK_UNIT);
				$this->gTpl->setContent($bb_edit->getHtml());
				break;
			case "editBlankBuildingBlock":
				$bb_edit = $this->getBuildingBlockEditGUI(gevSettings::EDIT_BUILDING_BLOCKS, $_GET["bb_id"], ilBuildingBlockEditGUI::EDIT_BLANK_UNIT);
				$this->gTpl->setContent($bb_edit->getHtml());
				break;
			case "saveBlankBuildingBlock":
				$bb_edit = $this->getBuildingBlockEditGUI(gevSettings::EDIT_BUILDING_BLOCKS, $_GET["bb_id"], ilBuildingBlockEditGUI::SAVE_BLANK_UNIT);
				$this->gTpl->setContent($bb_edit->save());
				break;
			case "updateBlankBuildingBlock":
				$bb_edit = $this->getBuildingBlockEditGUI(gevSettings::EDIT_BUILDING_BLOCKS, $_GET["bb_id"], ilBuildingBlockEditGUI::UPDATE_BLANK_UNIT);
				$this->gTpl->setContent($bb_edit->update());
				break;
	...
	protected function showContent() {
		...
		$add_building_bock_link = $this->gCtrl->getLinkTarget($this, "addBlankBuildingBlock");
		$this->gToolbar->addButton( $this->lng->txt("rep_robj_xbbp_add_blank_building_block"), $add_building_bock_link);
