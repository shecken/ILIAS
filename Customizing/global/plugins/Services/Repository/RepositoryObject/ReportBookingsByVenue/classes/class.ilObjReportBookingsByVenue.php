...
class ilObjReportBookingsByVenue extends ilObjReportBase
{
	...
	protected function buildFilter($filter)
	{
		...
		$filter	->checkbox("show_past_events", $this->plugin->txt("filter_show_past_events"), " checked >= 0 ", " checked = 0 ", true)
				->dateperiod("period", $this->plugin->txt("period"), $this->plugin->txt("until"), "crs.begin_date", "crs.end_date", date("Y")."-01-01", date("Y")."-12-31", false, " OR TRUE ")
