...
class ilStudyProgrammeDashboardViewGUI
{
    ...
    public function getHTML() : string
    {
        ...
        $panel = $this->factory->panel()->listing()->standard("Study Programme", $group);
    ...
    protected function findValidationValues(array $assignments) : array
    {
        try {
            ...
            $valid = true;
            if(
                ! is_null($validation_date) &&
                $validation_date->format('Y-m-d') <= date('Y-m-d')
            ) {
                $valid = false;
            }
    ...
    protected function findValid(array $assignments)
    {
        ...
        throw new ilStudyProgrammeDashboardException("no completed sp found");
    }
