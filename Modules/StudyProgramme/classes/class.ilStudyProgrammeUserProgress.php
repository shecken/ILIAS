...
class ilStudyProgrammeUserProgress
{
	 ...
	 */
	public static function getInstance($a_assignment_id, $a_program_id, $a_user_id)
	{
	 ...
	 * @return ilStudyProgrammeUserProgress
	 */
	public static function getInstanceById($a_prgrs_id)
	{
	 ...
	 * @return ilStudyProgrammeUserProgress[]
	 */
	public static function getInstancesForUser($a_program_id, $a_user_id)
	{
	 ...
	 */
	public static function statusToRepr($a_status)
	{
		global $lng;
