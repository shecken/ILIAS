...
class ilTestEvaluationGUI extends ilTestServiceGUI
{
	...
	*/
	function detailedEvaluation()
	{
		...
		$this->tpl->setVariable("HEADING_DETAILED_EVALUATION", sprintf(
...
*/
	...
	*/
	function outParticipantsPassDetails()
	{
		...
		//gev-patch start 2598
		$export_as_pdf = array_key_exists("pdf", $_GET) && ($_GET["pdf"] == 1);
	...
	*/
	function outUserResultsOverview()
	{
		...
		if (!is_null($pass)) {
			...
			} elseif ($this->object->getShowSolutionDetails()) {
