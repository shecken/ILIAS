...
class gevCrsMailAttachments extends ilMailAttachments {
    ...
    const LIST_FOR_TRAINER_NAME = "Participant_List_Trainer.xls";
    const LIST_FOR_HOTEL_NAME = "Participant_List_Accomodation.xls";
    const LIST_FOR_PARTICIPANT_NAME = "Participant_List_Course.xls";
    const MATERIAL_LIST = "Material_List.xls";
