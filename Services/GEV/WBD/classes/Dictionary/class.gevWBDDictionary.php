	...
	static $mappings = array(
		"toWBDName" => array(
			...
			"course_type" => array(
				...
				'Privat-Vorsorge-Lebens-/Rentenversicherung' => '001',
		...
		"toInternalName" => array(
			"gender" => array(
				"001" => "m",
				"002" => "f"
			),
			"course_type" => array(
				"001" => "Präsenz-Veranstaltung",
				"002" => "Einzeltraining",
			...
			"group_of_persons" => array(
				"001" => "Ausschließlichkeitsvermittler",
