...
class ilRbacReview
{
	...
	*/
	public function __getParentRoles($a_path, $a_templates, $a_keep_protected)
	{
		global $log,$ilDB;
	...
	*/
	public function getParentRoleIds($a_endnode_id, $a_templates = false, $a_keep_protected = false)
	{
	...
	*/
	public function __setTemplateFilter($a_templates)
	{
		global $ilDB;
	...
	*/
	public function __setRoleType($a_role_list)
	{
	...
	* @return	array
	*/
	public function __getAllRoleFolderIds()
	{
		global $ilDB;
	...
	*/
	public function getRoleFolderOfObject($a_ref_id)
	{
		global $tree,$ilBench;
	...
	public function getRoleFolderIdOfObject($a_ref_id)
	{
	...
	*/
	...
	//gev-patch start #3033
	public function getRolesByFilter($a_filter = 0, $a_user_id = 0, $title_filter = '', $period_data = false)
	{
		global $ilDB;
	...
	* @return	array		Array with rol_ids
	*/
	public function getLinkedRolesOfRoleFolder($a_ref_id)
	{
		global $ilDB;
	...
	public function __setProtectedStatus($a_parent_roles, $a_role_hierarchy, $a_ref_id)
	{
