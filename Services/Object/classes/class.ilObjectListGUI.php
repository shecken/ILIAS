...
class ilObjectListGUI
{
	...
	*
	*/
	public function ilObjectListGUI()
	{
...
//echo "list";
	...
	* @return void
	*/
	public function enablePayment($a_status)
	{
	...
	* @return void
	*/
	public function enablePath($a_path)
	{
	...
	*/
	public function initItem($a_ref_id, $a_obj_id, $a_title = "", $a_description = "", $a_context = self::CONTEXT_REPOSITORY)
	{
	...
	* @access	private
	*/
	public function insertProperties($a_item = '')
	{
