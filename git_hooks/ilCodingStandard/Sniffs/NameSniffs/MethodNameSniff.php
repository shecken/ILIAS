...
class  ilCodingStandard_Sniffs_NameSniffs_MethodNameSniff
	...
	public function process(PHP_CodeSniffer_File $phpcs_file, $stack_ptr) {
		...
		if(null !== $method_name) {
			if(!$this->validName($method_name)) {
				$this->handleError(
					$phpcs_file, sprintf(self::INVALID_METHOD_NAME_ERROR, $context_name, $method_name), $stack_ptr, $tokens[$stack_ptr]);
			}
		} else {
